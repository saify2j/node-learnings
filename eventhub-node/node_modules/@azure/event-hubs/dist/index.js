...
class FairPartitionLoadBalancer {
     ...
     */
    _shouldOwnMorePartitions(ourOwnerId, minPartitionsPerEventProcessor, partitionIds, ownerPartitionMap) {
    ...
    loadBalance(ourOwnerId, partitionOwnershipMap, partitionsToAdd) {
      ...
      expected number of event processors with additional partition: ${numberOfEventProcessorsWithAdditionalPartition}.`);
        ...
        if (!this._shouldOwnMorePartitions(ourOwnerId, minPartitionsPerEventProcessor, partitionsToAdd, ownerPartitionMap)) {
...
function getStartPosition(partitionIdToClaim, startPositions) {
    ...
    if (startPositions.offset != undefined ||
